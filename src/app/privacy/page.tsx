            ...
            >
              <div className="space-y-8 text-foreground-muted font-light leading-relaxed">
                ...
                <section>
                  ...
                  <h3 className="font-semibold text-lg text-foreground mb-3">Interpretation</h3>
                  <p className="mb-6">
                    The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                  </p>

                  <h3 className="font-semibold text-lg text-foreground mb-3">Definitions</h3>
                ...
                <section>
                  ...
                  <h3 className="font-semibold text-lg text-foreground mb-3">Types of Data Collected</h3>

                  <h4 className="font-semibold text-foreground mb-2 mt-4">Personal Data</h4>
                  <p className="mb-4">
                    While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
                  </p>
                  <ul className="space-y-2 pl-6 mb-6">
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Email address</li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">First name and last name</li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Phone number</li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Address, State, Province, ZIP/Postal code, City</li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Usage Data</li>
                  </ul>
                  ...
                  <h4 className="font-semibold text-foreground mb-2">Tracking Technologies and Cookies</h4>
                  <p className="mb-4">
                  ...
                  <ul className="space-y-3 pl-6 mb-4">
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                      <strong className="text-foreground">Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.
                    </li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                  ...
                  <ul className="space-y-4 pl-6 mb-6">
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                      <strong className="text-foreground">Necessary / Essential Cookies</strong>
                      <p className="mt-1">Type: Session Cookies</p>
                      <p>Administered by: Us</p>
                      <p>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                    </li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                      <strong className="text-foreground">Cookies Policy / Notice Acceptance Cookies</strong>
                ...
                <section>
                  <h3 className="font-semibold text-lg text-foreground mb-3">Use of Your Personal Data</h3>
                  ...
                  <ul className="space-y-3 pl-6 mb-6">
                    ...
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                      <strong className="text-foreground">For business transfers:</strong> We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred.
                    </li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                  ...
                  <ul className="space-y-3 pl-6 mb-6">
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                      <strong className="text-foreground">With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.
                    </li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                      <strong className="text-foreground">For business transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.
                    </li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                    ...
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                      <strong className="text-foreground">With business partners:</strong> We may share Your information with Our business partners to offer You certain products, services or promotions.
                    </li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                      <strong className="text-foreground">With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.
                    </li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">
                ...
                <section>
                  <h3 className="font-semibold text-lg text-foreground mb-3">Retention of Your Personal Data</h3>
                  <p className="mb-4">
                ...
                <section>
                  <h3 className="font-semibold text-lg text-foreground mb-3">Transfer of Your Personal Data</h3>
                  <p className="mb-4">
                ...
                <section>
                  <h3 className="font-semibold text-lg text-foreground mb-3">Delete Your Personal Data</h3>
                  <p className="mb-4">
                ...
                <section>
                  <h3 className="font-semibold text-lg text-foreground mb-3">Disclosure of Your Personal Data</h3>

                  <h4 className="font-semibold text-foreground mb-2 mt-4">Business Transactions</h4>
                  <p className="mb-4">
                    If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                  </p>

                  <h4 className="font-semibold text-foreground mb-2">Law enforcement</h4>
                  <p className="mb-4">
                    Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                  </p>

                  <h4 className="font-semibold text-foreground mb-2">Other legal requirements</h4>
                  <p className="mb-4">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
                  <ul className="space-y-2 pl-6 mb-6">
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Comply with a legal obligation</li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Protect and defend the rights or property of the Company</li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Prevent or investigate possible wrongdoing in connection with the Service</li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Protect the personal safety of Users of the Service or the public</li>
                    <li className="relative before:content-[''] before:absolute before:left-[-1rem] before:top-[0.6rem] before:w-1.5 before:h-1.5 before:bg-primary before:rounded-full">Protect against legal liability</li>
                  </ul>
                </section>

                {/* Security of Your Personal Data */}
                <section>
                  <h3 className="font-semibold text-lg text-foreground mb-3">Security of Your Personal Data</h3>
                  <p className="mb-6">
